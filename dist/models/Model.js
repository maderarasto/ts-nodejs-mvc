...
const DbEntity_1 = __importDefault(require("../database/DbEntity"));
exports.default = (() => {
    var _a;
    let _instanceExtraInitializers = [];
    let _id_decorators;
    let _id_initializers = [];
    return _a = class Model extends DbEntity_1.default {
            constructor(data = {}) {
                super();
                this.attributes = (__runInitializers(this, _instanceExtraInitializers), {});
        ...
        (() => {
            _id_decorators = [DbEntity_1.default.column];
